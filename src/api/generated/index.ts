...
export type deleteSystemResponseError = (
  | deleteSystemResponse401
  | deleteSystemResponse404
  | deleteSystemResponseDefault
) & {
  headers: Headers;
};

export type deleteSystemResponse =
  | deleteSystemResponseSuccess
  | deleteSystemResponseError;
 ...
 * @summary Delete a system
 */
export const useDeleteSystem = <TError = Error, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteSystem>>,
      TError,
...
export const getLsUrl = (systemId: string, params: LsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/syscall/${systemId}/ls?${stringifiedParams}`
    : `/api/syscall/${systemId}/ls`;
};
...
export const getLsQueryKey = (systemId: string, params?: LsParams) => {
  return [`/api/syscall/${systemId}/ls`, ...(params ? [params] : [])] as const;
};
...
export const getUnlinkUrl = (systemId: string, params: UnlinkParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/syscall/${systemId}/unlink?${stringifiedParams}`
    : `/api/syscall/${systemId}/unlink`;
};
 ...
 * @summary Remove multiple paths
 */
export const useRm = <TError = Error, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof rm>>,
      TError,
