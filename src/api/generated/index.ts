 ...
 */
export type deleteSystemResponse204 = {
  data: void
  status: 204
}

export type deleteSystemResponse401 = {
  data: Error
  status: 401
}

export type deleteSystemResponse404 = {
  data: Error
  status: 404
}

export type deleteSystemResponseDefault = {
  data: Error
  status: Exclude<HTTPStatusCodes, 204 | 401 | 404>
}

export type deleteSystemResponseSuccess = (deleteSystemResponse204) & {
  headers: Headers;
};
export type deleteSystemResponseError = (deleteSystemResponse401 | deleteSystemResponse404 | deleteSystemResponseDefault) & {
  headers: Headers;
};

export type deleteSystemResponse = (deleteSystemResponseSuccess | deleteSystemResponseError)

export const getDeleteSystemUrl = (systemId: string,) => {
...
export const deleteSystem = async (systemId: string, options?: RequestInit): Promise<deleteSystemResponse> => {

  const res = await fetch(getDeleteSystemUrl(systemId),
  {
    ...options,
    method: 'DELETE'
  ...
  const data: deleteSystemResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as deleteSystemResponse
}




export const getDeleteSystemMutationOptions = <TError = Error,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteSystem>>, TError,{systemId: string}, TContext>, fetch?: RequestInit}
): UseMutationOptions<Awaited<ReturnType<typeof deleteSystem>>, TError,{systemId: string}, TContext> => {
...
const {mutation: mutationOptions, fetch: fetchOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteSystem>>, {systemId: string}> = (props) => {
          const {systemId} = props ?? {};

          return  deleteSystem(systemId,fetchOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteSystemMutationError = Error

    /**
 * @summary Delete a system
 */
export const useDeleteSystem = <TError = Error,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteSystem>>, TError,{systemId: string}, TContext>, fetch?: RequestInit}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteSystemMutationOptions(options), queryClient);
    }
...
export const getLsUrl = (systemId: string,
  ...
  return stringifiedParams.length > 0 ? `/api/syscall/${systemId}/ls?${stringifiedParams}` : `/api/syscall/${systemId}/ls`
}
...
export const getLsQueryKey = (systemId: string,
    params?: LsParams,) => {
    return [
    `/api/syscall/${systemId}/ls`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getMkdirUrl = (systemId: string,) => {
  ...
  return `/api/syscall/${systemId}/mkdir`
}
...
export const getLnUrl = (systemId: string,) => {
  ...
  return `/api/syscall/${systemId}/ln`
}
...
export const getRenameUrl = (systemId: string,) => {
  ...
  return `/api/syscall/${systemId}/rename`
}

export const rename = async (systemId: string,
    renameRequest: RenameRequest, options?: RequestInit): Promise<renameResponse> => {
...
export const getRenameMutationOptions = <TError = Error,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof rename>>, TError,{systemId: string;data: RenameRequest}, TContext>, fetch?: RequestInit}
): UseMutationOptions<Awaited<ReturnType<typeof rename>>, TError,{systemId: string;data: RenameRequest}, TContext> => {
...
const {mutation: mutationOptions, fetch: fetchOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof rename>>, {systemId: string;data: RenameRequest}> = (props) => {
          const {systemId,data} = props ?? {};
...
export const useRename = <TError = Error,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {systemId: string;data: RenameRequest},
        TContext
      > => {
...
export const getUnlinkUrl = (systemId: string,
  ...
  return stringifiedParams.length > 0 ? `/api/syscall/${systemId}/unlink?${stringifiedParams}` : `/api/syscall/${systemId}/unlink`
}
 ...
 * @summary Remove multiple paths
 */
export type rmResponse200 = {
  data: RmResult
  status: 200
}
...
export type rmResponseSuccess = (rmResponse200) & {
  headers: Headers;
};
export type rmResponseError = (rmResponse400 | rmResponse401 | rmResponse403 | rmResponseDefault) & {
  headers: Headers;
};

export type rmResponse = (rmResponseSuccess | rmResponseError)

export const getRmUrl = (systemId: string,) => {




  return `/api/syscall/${systemId}/rm`
}

export const rm = async (systemId: string,
    rmRequest: RmRequest, options?: RequestInit): Promise<rmResponse> => {

  const res = await fetch(getRmUrl(systemId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
  ...
  const data: rmResponse['data'] = body ? JSON.parse(body) : {}
...
export const getRmMutationOptions = <TError = Error,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof rm>>, TError,{systemId: string;data: RmRequest}, TContext>, fetch?: RequestInit}
): UseMutationOptions<Awaited<ReturnType<typeof rm>>, TError,{systemId: string;data: RmRequest}, TContext> => {
...
const {mutation: mutationOptions, fetch: fetchOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof rm>>, {systemId: string;data: RmRequest}> = (props) => {
          const {systemId,data} = props ?? {};

          return  rm(systemId,data,fetchOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RmMutationBody = RmRequest
...
export const useRm = <TError = Error,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {systemId: string;data: RmRequest},
        TContext
      > => {
...
export type mvResponseError = (mvResponse400 | mvResponse401 | mvResponse403 | mvResponseDefault) & {
  headers: Headers;
};
...
export const getMvUrl = (systemId: string,) => {
  ...
  return `/api/syscall/${systemId}/mv`
}

export const mv = async (systemId: string,
    mvRequest: MvRequest, options?: RequestInit): Promise<mvResponse> => {
...
export const getMvMutationOptions = <TError = Error,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof mv>>, TError,{systemId: string;data: MvRequest}, TContext>, fetch?: RequestInit}
): UseMutationOptions<Awaited<ReturnType<typeof mv>>, TError,{systemId: string;data: MvRequest}, TContext> => {
...
const {mutation: mutationOptions, fetch: fetchOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof mv>>, {systemId: string;data: MvRequest}> = (props) => {
          const {systemId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type MvMutationBody = MvRequest
...
export const useMv = <TError = Error,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {systemId: string;data: MvRequest},
        TContext
      > => {
